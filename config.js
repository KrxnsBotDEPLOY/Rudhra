...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'default' : process.env.🐲𒁂🦠 ⚜️ KRXNS!🦇  {𝐒 𝐋 ☘},
    ALL: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ᴘʀɪɴᴄᴇʀᴜᴅʜ' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '50938578360@s.whatsapp.net' : process.env.TAG_REPLY,
